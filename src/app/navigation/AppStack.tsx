...
import Connections from "../../features/connections/screens/Connections";
import Requests from "../../features/connections/screens/Requests";
...
function TabNavigator() {
    ...
    return (
        <Tab.Navigator
            screenOptions={({ route }) => ({
                tabBarIcon: ({ focused }) => {
                    ...
                    if (route.name === "Home") {
                        // Double overlapping hearts icon
                        return (
        ...
        >
            ...
            <Tab.Screen name="Nearby" component={Connections} options={{ tabBarLabel: "Nearby" }} />
            <Tab.Screen name="Chats" component={Chat} options={{ tabBarLabel: "Chats" }} />
            <Tab.Screen name="MyFans" component={Requests} options={{ tabBarLabel: "My Fans" }} />
